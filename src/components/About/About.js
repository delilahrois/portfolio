    ...
    <div>
      ...
      <div className="about">
        ...
        <div className="about-txt-container">
          ...
          <p>My passion for creativity and giving nature led me to a life in the hospitality industry. With the rise of Covid-19 in 2020, I began to question everything. Eventually I found my way to Codecademy and tried my first free lesson. After that, I was hooked-- I knew I wanted to learn to program, and I knew I wanted to do it at <Link to="" onClick={() => directUser()}>Turing School of Software and Design</Link> in Denver.  </p>
